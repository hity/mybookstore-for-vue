    ...
    <div class="book-add-wp">
        ...
        <section class="book-individual">
            ...
            <section v-if="stockInfo.stockStatus === '待购'" class="supplement-block">
                ...
                <template v-if="isToBuy && isToBuy[0] === '加入'">
            ...
            <section v-if="readInfo.readStatus === '未读'" class="supplement-block">
                ...
                <template v-if="isToRead && isToRead[0] == '加入'">
...
export default {
    ...
    created() {
        ...
        this.getTagList();
        this.getPosList();
        if (this.oprType === 'onlineBook') {
            this.baseInfo = Object.assign(this.baseInfo, this.onlineDetail);
        }
    },
    computed: {
        finalTagList() {
        ...
        ...mapState('input', {
            onlineDetail: state => state.onlineDetail,
        }),
    },
    methods: {
        ...mapActions('list', [
        ...
        getBookDetail() {
            let id = this.$route.params.bookId || this.bookId;
